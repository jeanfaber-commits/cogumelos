...
function Composto() {
  ...
  const r = calcularComposto(config, alvoKg)

  return (
    <div className="card">
      <div className="section-title">Composto → substrato</div>
      <div className="section-sub">Quanto de cada ingrediente e quanta água para o alvo, a {config.umidadeAlvoSubstratoPct}% de umidade.</div>
      ...
      <div className="tbl-scroll">
        <table className="tbl">
          <thead>
            <tr><th>Ingrediente</th><th className="r">Matéria seca</th><th className="r">Peso úmido</th></tr>
          </thead>
          <tbody>
            {r.linhas.map((l) => (
              <tr key={l.nome}>
            ...
            <tr>
              <td>Água a adicionar</td>
              <td className="r">—</td>
              <td className="r">{fmt(r.aguaAdicionarKg)} kg</td>
            </tr>
          </tbody>
          <tfoot>
            <tr><td>Total (substrato pronto)</td><td className="r">{fmt(r.massaSecaKg)} kg</td><td className="r">{fmt(r.totalKg)} kg</td></tr>
          </tfoot>
        </table>
      </div>
    ...
    <div className="card">
      ...
      <div style={{ display: 'flex', gap: 12, marginTop: 12, flexWrap: 'wrap' }}>
        <div className="metric" style={{ flex: 1, minWidth: 150 }}>
          ...
          <div className="metric-value tnum" style={{ fontSize: 24 }}>{fmt(r.clF2Kg, 2)}<span className="metric-unit">kg</span></div>
  ...
  return (
    <>
      <div className="page-head">
        ...
        <p className="page-desc">Cálculo de ingredientes para composto e para spawn. Usa os valores das Configurações.</p>
      </div>
      <Composto />
      <Spawn />
    </>
